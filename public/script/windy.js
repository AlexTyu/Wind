...
var Windy = function( params ){
  var VELOCITY_SCALE = 1/90000;             // scale for wind velocity (completely arbitrary--this value looks nice)
  ...
  var PARTICLE_MULTIPLIER = 0.9;              // particle count scalar (completely arbitrary--this values looks nice)
  ...
  var animate = function(bounds, field) {
    ...
    function windIntensityColorScale(step, maxWind) {
        ...
        result = [
          ...
          /*"rgba(" + hexToR('#FFFF19') + ", " + hexToG('#FFFF19') + ", " + hexToB('#FFFF19') + ", " + 0.5 + ")",
          "rgba(" + hexToR('#66FF33') + ", " + hexToG('#66FF33') + ", " + hexToB('#66FF33') + ", " + 0.5 + ")",
          "rgba(" + hexToR('#0066FF') + ", " + hexToG('#0066FF') + ", " + hexToB('#0066FF') + ", " + 0.5 + ")",
          "rgba(" + hexToR('#FF3399') + ", " + hexToG('#FF3399') + ", " + hexToB('#FF3399') + ", " + 0.5 + ")",
    ...
    var fadeFillStyle = "rgba(0, 0, 0, 0.96)";
